...
class GmailClient:
    def __init__(self, backend_url: str = "http://localhost:8000", session_file: Union[str, Path] = None, rpm: int = 60):
    ...
    def get_attachment(self, message_id: str, attachment_id: str, output_path: Optional[Union[str, Path]] = None) -> bytes:
        ...
        attachment_bytes = base64.urlsafe_b64decode(b64)
    ...
    download_all_attachments = get_all_attachments
    ...
    async def get_all_attachments_async(self, message_id: str, output_dir: Union[str, Path] = "./attachments") -> List[Path]:
        output_dir = Path(output_dir)
        output_dir.mkdir(parents=True, exist_ok=True)
